                ...
                <tbody>
                    @foreach($orders as $order)
                        @php
                            ...
                            $currentStatus = $statusMap[$order->status] ?? 'tertunda';
                            ...
                            <td class="p-3">
                                <form action="{{ route('admin.orders.updateStatus', $order->id) }}"
                                    ...
                                    <select name="status"
                                        ...
                                        class="border rounded px-3 py-1 text-sm font-semibold
                                        {{ $statusClass[$currentStatus] ?? 'bg-gray-100 text-gray-800' }}">
                                        @foreach (['tertunda', 'diproses', 'dikirim', 'selesai', 'dibatalkan'] as $status)
                                            <option value="{{ $status }}"
